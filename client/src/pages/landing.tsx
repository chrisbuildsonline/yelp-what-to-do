...
import modernBrunchImage from '@assets/images/modern_brunch_cafe_interior.png';
import friendsDiningImage from '@assets/images/friends_dining_at_night.png';
import scenicHikingImage from '@assets/images/scenic_hiking_trail.png';
